...
public class MirrorMain {
    ...
    private final Thread.UncaughtExceptionHandler uncaughtExceptionHandler = (t, e) -> log.error("Uncaught Exception (thread "+t.getName()+"): "+e, e);
